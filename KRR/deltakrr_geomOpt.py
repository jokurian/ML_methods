...
# atoms = read("./methylpropanoate.xyz")
...
def ase_energy_and_grad(mol):
    ...
    gradient_ha_perA = -forces_ev / 27.211386  # negative: dE/dx
    gradient_ha_perBohr = gradient_ha_perA / 1.88973 #0.529177  # convert Å → Bohr
